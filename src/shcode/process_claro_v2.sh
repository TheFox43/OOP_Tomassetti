...
OUTFILE="../../outdata/processed_data.csv}"
FFILEIN="../../outdata/file_lists/filein_files.txt"
FFILEOUT="../../outdata/file_lists/good_files.txt"
...
echo "N,M,Chip#,Offset,Ch,TRANS,WIDTH" > "../../outdata/file_lists/bad_files.txt"
...
while IFS= read -r FILENAME; do
	...
	if [[ -n $VALUES ]]; then
		...
		echo "$FILENAME" >> "../../outdata/file_lists/bad_files.txt"
	fi
